...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/easticoin-project/easticoin>";
    const std::string URL_WEBSITE = "<https://easticoin.org>";
