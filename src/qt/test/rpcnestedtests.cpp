...
void RPCNestedTests::rpcNestedTests()
{
    ...
    ClearDatadirCache();
    std::string path = QDir::tempPath().toStdString() + "/" + strprintf("test_easticoin_qt_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
    ...
    QVERIFY(result == "c608d0ccffb1e3dd9f57ea40d366a3665aae68231ba43593f5e2d954a5d12ec3");
