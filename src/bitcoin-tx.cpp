...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s easticoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  easticoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded easticoin transaction") + "\n" +
              "  easticoin-tx [options] -create [commands]   " + _("Create hex-encoded easticoin transaction") + "\n" +
              "\n";
